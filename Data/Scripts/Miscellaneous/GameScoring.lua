...
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
--              $File: //depot/Projects/StarWars_Expansion/Run/Data/Scripts/Miscellaneous/GameScoring.lua $
--
...
function Print_Stat_Table(stat_table)
    ...
    for k,player in pairs(PlayerTable) do
        ...
        elseif dt == nil or dt.combat_power == 0 then
            ...
            GameScoringMessage("\tPlayer %s, Weighted Kill Ratio: %f", player.Get_Name(), ft.combat_power / dt.combat_power)
        end
    end
end
...
function Galactic_Production_End_Event(planet, object)
    ...
    if object.Get_Type == nil then
        ...
        Update_Build_Stats_Table(GalacticBuildStatsTable, planet, object.Get_Game_Scoring_Type(), planet.Get_Owner(), object.Get_Game_Scoring_Type().Get_Build_Cost())
