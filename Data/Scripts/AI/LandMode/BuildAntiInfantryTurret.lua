...
function Definitions()
	...
	TaskForce = {
	{
		"MainForce"					
		,"TaskForceRequired"
		,"UC_Empire_Buildable_Anti_Infantry_Turret | UC_Rebel_Buildable_Anti_Infantry_Turret | UC_Underworld_Buildable_Flame_Turret | UC_Pirate_Buildable_Anti_Infantry_Turret | UC_Pentastar_Buildable_Anti_Infantry_Turret | UC_Hutt_Rapid_Fire_Laser_Turret = 1"
	}
	}
