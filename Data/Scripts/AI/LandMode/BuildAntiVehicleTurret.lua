...
function Definitions()
	...
	TaskForce = {
	{
		"MainForce"					
		,"TaskForceRequired"
		,"UC_Empire_Buildable_Anti_Vehicle_Turret | UC_Rebel_Buildable_Anti_Vehicle_Turret | UC_Underworld_Buildable_Anti_Vehicle_Turret | UC_Pirate_Buildable_Anti_Vehicle_Turret | UC_Pentastar_Buildable_Anti_Vehicle_Turret | UC_Hutt_Grenade_Mortar = 1"
	}
	}
