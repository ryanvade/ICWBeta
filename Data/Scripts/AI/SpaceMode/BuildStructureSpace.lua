...
function Definitions()
	...
	{
		"MainForce"
		,"UC_Empire_Defense_Satellite_Laser | UC_Empire_Defense_Satellite_Missile | UC_Empire_Defense_Satellite_Repair = 0,1"
		,"UC_Pentastar_Defense_Satellite_Laser | UC_Pentastar_Defense_Satellite_Missile | UC_Pentastar_Defense_Satellite_Repair = 0,1"
