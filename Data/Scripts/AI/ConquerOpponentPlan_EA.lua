...
function Definitions()
    MinContrastScale = 0.9
    MaxContrastScale = 1.5

    Category = "Warlord_Conquer_Opponent"
    TaskForce = {
        -- First Task Force
        {
            "SpaceForce",
        ...
        {
            "GroundForce",
            "MinimumTotalForce = 800",
            "LandHero | Vehicle | Infantry | Air = 100%"
        }
    }
    RequiredCategories = {"Infantry", "Vehicle", "Corvette | Frigate | Interdictor | Capital"} --Must have at least one ground unit, also make sure space force is reasonable
