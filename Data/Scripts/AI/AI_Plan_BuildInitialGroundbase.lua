...
function Definitions()
	...
	{
		"BaseForce",
		"Empire_MoffPalace | Maldrood_MoffPalace | Zsinj_MoffPalace | Eriadu_MoffPalace | Pentastar_MoffPalace | Hand_GovernorOffice | NewRep_SenatorsOffice | CSA_LocalOffice = 1"
	}
	}
