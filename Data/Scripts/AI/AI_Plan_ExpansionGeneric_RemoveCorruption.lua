	...
	TaskForce = {
		{
			"MainForce",
			"DenyHeroAttach",
			"Mon_Mothma_Team | Obi_Wan_Team | Katarn_Team | Yoda_Team | Luke_Skywalker_Jedi_Team | Han_Solo_Team | Emperor_Palpatine_Team | General_Veers_Team | Darth_Team | Mara_Jade_Team = 1"
		}
	}
end
