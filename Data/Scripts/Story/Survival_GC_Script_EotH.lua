...
--*   @Filename:            Survival_GC_Script_EotH.lua
--*   @Last modified by:    [TR]Pox
--*   @Last modified time:  2017-12-21T13:18:28+01:00
...
function Get_WaveCount(message)
	if message == OnEnter then
		...
		--wave_count = 5
		plot = Get_Story_Plot("Story_Sandbox_Survival_EotH.XML")
		...
		event.Add_Dialog_Text("TEXT_DISPLAY_STRUCTURE", wave_count)
		Story_Event("DIALOG")
