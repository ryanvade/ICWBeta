...
function CountStructuresOnPlanet(structuresOnPlanet, structure, structureInfo, planet)
  if structureInfo.Equation then
    structuresOnPlanet[structureInfo.Text] = EvaluatePerception(structureInfo.Equation, planet.Get_Owner(), planet)
  else
    CountStructuresManually(structuresOnPlanet, structure, structureInfo, planet)
  end
end

function CountStructuresManually(structuresOnPlanet, structure, structureInfo, planet)
