...
function BuildableUnit(unitTypeString)
    return {
        ...
        execute = function(self)
            require("TRUtil")
            TRUtil.BuildableUnit(self.typeString)
        end
    }
end
...
function LockUnit(unitTypeString)
    return {
        ...
        execute = function(self)
            require("TRUtil")
            TRUtil.LockUnit(self.typeString)
        end
    }
end
        ...
        reward = {
            ...
            determineLocation = function(self)
                ...
                if not self.location or self.location.Get_Owner() ~= self.player then
                    require("TRUtil")
                    return TRUtil.FindFriendlyPlanet(self.player)
                end
