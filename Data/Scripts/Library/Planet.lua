...
function Planet:update_influence_information()
    ...
    if self:get_owner() ~= Find_Player("Neutral") then
        ...
        if self.weeksControlled >= 1 and self.weeksControlled < 2 then
            self.ownerInfluence = self.ownerInfluence + 1
        elseif self.weeksControlled >= 2 and self.weeksControlled < 3 then
            self.ownerInfluence = self.ownerInfluence + 2
        elseif self.weeksControlled >= 3 and self.weeksControlled < 4 then
            self.ownerInfluence = self.ownerInfluence + 3
        elseif self.weeksControlled >= 4 and self.weeksControlled < 5 then
            self.ownerInfluence = self.ownerInfluence + 4
        elseif self.weeksControlled >= 5 then
        ...
        if oldInfluence ~= self.ownerInfluence then
