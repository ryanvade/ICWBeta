...
function MakeRaidFleet(chance)
    ...
    RaidFleet.unit_types = {
        {"Skirmish_CR90", "Skirmish_MC80B", "Skirmish_MC40a", "Skirmish_Alliance_Assault_Frigate"},
        {
        ...
        {
            "Skirmish_Tartan_Patrol_Cruiser",
            "Skirmish_Victory_II_Frigate",
            "Skirmish_Tector",
            "Skirmish_Victory_Destroyer_Two",
            "Skirmish_Broadside_Cruiser",
            "Skirmish_Imperial_II_Frigate"
        },
        {"Nova_Cruiser", "BattleDragon"},
        {
            "Skirmish_Invincible_Cruiser",
            "Skirmish_Recusant",
            "Skirmish_Bulwark_I",
            "Skirmish_Gladiator",
            "Skirmish_Marauder"
    ...
    RaidFleet.starbases = {
        {"NR_Star_Base_1", "NR_Star_Base_2", "NR_Star_Base_3", "NR_Star_Base_4"},
